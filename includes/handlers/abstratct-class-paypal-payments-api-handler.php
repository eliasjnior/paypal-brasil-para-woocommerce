...
/**
 * Class PayPal_Payments_API_Handler.
 */
abstract class PayPal_Payments_API_Handler {
	...
	/**
	 * @param PayPal_Payments_Gateway $gateway
	 *
	 * @return array
	 */
	 ...
	 *
	 * @return PayPal_Payments_Gateway
	 * @throws Exception
	 */
	protected function get_paypal_gateway( $gateway ) {
		...
		throw new Exception( __( 'O método de pagamento do PayPal não foi encontrado', 'paypal-payments' ) );
	}
