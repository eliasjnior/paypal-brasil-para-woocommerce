<div class="admin-options-container">
	...
	<div class="alert-dialog" v-if="showAlert && mode === 'live'">
		<div class="dialog-content">
			...
			<p>Prezado cliente, o <strong>Checkout Transparente do PayPal</strong> só funciona em produção mediante liberação
				comercial, caso
				você já tenha recebido a aprovação, ignore esta mensagem. Caso o contrário, peça agora pelo link ou ligue na
				nossa central (0800 721 6959).</p>
